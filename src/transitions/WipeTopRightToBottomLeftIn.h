...
//---------------------------------------------------------------------
//
//	File:	WipeTopRightToBottomLeftIn.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class WipeTopRightToBottomLeftIn : public TTransitionEffect 
{
	public:
		WipeTopRightToBottomLeftIn();
		
		// Construct self from a message
		WipeTopRightToBottomLeftIn(BMessage* msg);
