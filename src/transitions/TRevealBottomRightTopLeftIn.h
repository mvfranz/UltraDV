#if !defined(__TREVEALBRTLIN_H__)
#define __TREVEALBRTLIN_H__

//---------------------------------------------------------------------
//
//	File:	TRevealBottomRightTopLeftIn.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class TRevealBottomRightTopLeftIn : public TTransitionEffect 
{
	public:
		TRevealBottomRightTopLeftIn();
		
		// Construct self from a message
		TRevealBottomRightTopLeftIn(BMessage* msg);
