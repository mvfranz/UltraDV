...
#include "TWipeDownOut.h"


//	Local Constants
const char *TWipeDownOut::kTransitionName = "WipeDownOut";
...
TWipeDownOut::TWipeDownOut() : TTransitionEffect(false)	//	This is an Out Transition
{
}


TWipeDownOut::TWipeDownOut(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TWipeDownOut::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t TWipeDownOut::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TWipeDownOut");	
...
string TWipeDownOut::Name() const
{
...
BBitmap *TWipeDownOut::TransformBitmap(uint32 time, const BBitmap *source,
