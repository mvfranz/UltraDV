...
#include "TWipeLeftIn.h"


//	Local Constants
const char *TWipeLeftIn::kTransitionName = "WipeLeftIn";
...
TWipeLeftIn::TWipeLeftIn() : TTransitionEffect(true)	//	This is an In Transition
{
}


TWipeLeftIn::TWipeLeftIn(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TWipeLeftIn::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t TWipeLeftIn::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TWipeLeftIn");	
...
BBitmap *TWipeLeftIn::TransformBitmap(uint32 time, const BBitmap *source,
