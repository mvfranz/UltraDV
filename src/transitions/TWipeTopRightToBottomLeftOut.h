#if !defined(__TWIPETRBLOUT_H__)
#define __TWIPETRBLOUT_H__

//---------------------------------------------------------------------
//
//	File:	TWipeTopRightToBottomLeftOut.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class TWipeTopRightToBottomLeftOut : public TTransitionEffect 
{
	public:
		TWipeTopRightToBottomLeftOut();
		
		// Construct self from a message
		TWipeTopRightToBottomLeftOut(BMessage* msg);
