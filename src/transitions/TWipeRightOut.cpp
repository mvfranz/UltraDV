...
TWipeRightOut::TWipeRightOut() : TTransitionEffect(false)       //	This is an Out Transition
{
}


TWipeRightOut::TWipeRightOut(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TWipeRightOut::Instantiate(BMessage* data)
{
	return NULL;
}

status_t TWipeRightOut::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TWipeRightOut");
...
string TWipeRightOut::Name() const
{
