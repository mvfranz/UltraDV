...
#include "TRevealLeftIn.h"


//	Local Constants
const char *TRevealLeftIn::kTransitionName = "RevealLeftIn";
...
TRevealLeftIn::TRevealLeftIn() : TTransitionEffect(true)        //	This is an In Transition
{
}


TRevealLeftIn::TRevealLeftIn(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TRevealLeftIn::Instantiate(BMessage* data)
{
	return NULL;
}

status_t TRevealLeftIn::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TRevealLeftIn");
...
string TRevealLeftIn::Name() const
{
...
BBitmap *TRevealLeftIn::TransformBitmap(uint32 time, const BBitmap *source,
