...
#include "TRevealRightOut.h"


//	Local Constants
const char *TRevealRightOut::kTransitionName = "RevealRightOut";
...
TRevealRightOut::TRevealRightOut() : TTransitionEffect(false)   //	This is an Out Transition
{
}


TRevealRightOut::TRevealRightOut(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TRevealRightOut::Instantiate(BMessage* data)
{
	return NULL;
}

status_t TRevealRightOut::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TRevealRightOut");
...
string TRevealRightOut::Name() const
{
...
BBitmap *TRevealRightOut::TransformBitmap(uint32 time, const BBitmap *source,
