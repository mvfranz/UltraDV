//---------------------------------------------------------------------
//
//	File:	WipeTopRightToBottomLeftIn.cpp
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.14.98
...
#include "WipeTopRightToBottomLeftIn.h"


//	Local Constants
const char *WipeTopRightToBottomLeftIn::kTransitionName = "WipeTopRightToBottomLeftIn";
...
WipeTopRightToBottomLeftIn::WipeTopRightToBottomLeftIn() : TTransitionEffect(true)	//	This is an In Transition
{
}


WipeTopRightToBottomLeftIn::WipeTopRightToBottomLeftIn(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* WipeTopRightToBottomLeftIn::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t WipeTopRightToBottomLeftIn::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "WipeTopRightToBottomLeftIn");	
...
string WipeTopRightToBottomLeftIn::Name() const
{
...
BBitmap *WipeTopRightToBottomLeftIn::TransformBitmap(uint32 time, const BBitmap *source,
