//---------------------------------------------------------------------
//
//	File:	TRevealTopLeftBottomRightIn.cpp
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.14.98
...
#include "TRevealTopLeftBottomRightIn.h"


//	Local Constants
const char* TRevealTopLeftBottomRightIn::kTransitionName = "RevealTopLeftBottomRightIn";
...
TRevealTopLeftBottomRightIn::TRevealTopLeftBottomRightIn() : TTransitionEffect(true)    //	This is an In Transition
{
}


TRevealTopLeftBottomRightIn::TRevealTopLeftBottomRightIn(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TRevealTopLeftBottomRightIn::Instantiate(BMessage* data)
{
	return NULL;
}

status_t TRevealTopLeftBottomRightIn::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TRevealTopLeftBottomRightIn");
...
string TRevealTopLeftBottomRightIn::Name() const
{
...
BBitmap* TRevealTopLeftBottomRightIn::TransformBitmap(uint32 time, const BBitmap* source,
