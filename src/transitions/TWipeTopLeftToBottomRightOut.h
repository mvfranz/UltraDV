#if !defined(__TWIPETLBROUT_H__)
#define __TWIPETLBROUT_H__

//---------------------------------------------------------------------
//
//	File:	TWipeTopLeftToBottomRightOut.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class TWipeTopLeftToBottomRightOut : public TTransitionEffect 
{
	public:
		TWipeTopLeftToBottomRightOut();
		
		// Construct self from a message
		TWipeTopLeftToBottomRightOut(BMessage* msg);
