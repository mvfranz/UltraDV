//---------------------------------------------------------------------
//
//	File:	TWipeTopRightToBottomLeftOut.cpp
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.14.98
...
#include "TWipeTopRightToBottomLeftOut.h"


//	Local Constants
const char *TWipeTopRightToBottomLeftOut::kTransitionName = "WipeTopLeftToBottomRightOut";
...
TWipeTopRightToBottomLeftOut::TWipeTopRightToBottomLeftOut() : TTransitionEffect(false)	//	This is an Out Transition
{
}


TWipeTopRightToBottomLeftOut::TWipeTopRightToBottomLeftOut(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TWipeTopRightToBottomLeftOut::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t TWipeTopRightToBottomLeftOut::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TWipeTopRightToBottomLeftOut");	
...
string TWipeTopRightToBottomLeftOut::Name() const
{
...
BBitmap *TWipeTopRightToBottomLeftOut::TransformBitmap(uint32 time, const BBitmap *source,
