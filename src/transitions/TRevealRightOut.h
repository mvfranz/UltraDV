#if !defined(__TREVEALRIGHTOUT_H__)
#define __TREVEALRIGHTOUT_H__

//---------------------------------------------------------------------
//
//	File:	TRevealRightOut.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class TRevealRightOut : public TTransitionEffect 
{
	public:
		TRevealRightOut();
		
		// Construct self from a message
		TRevealRightOut(BMessage* msg);
