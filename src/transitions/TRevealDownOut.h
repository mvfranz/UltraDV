#if !defined(__TREVEALDOWNOUT_H__)
#define __TREVEALDOWNOUT_H__

//---------------------------------------------------------------------
//
//	File:	TRevealDownOut.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class TRevealDownOut : public TTransitionEffect 
{
	public:
		TRevealDownOut();
		
		// Construct self from a message
		TRevealDownOut(BMessage* msg);
