//---------------------------------------------------------------------
//
//	File:	TRevealBottomRightTopLeftIn.cpp
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.14.98
...
#include "TRevealBottomRightTopLeftIn.h"


//	Local Constants
const char *TRevealBottomRightTopLeftIn::kTransitionName = "RevealBottomRightTopLeftIn";
...
TRevealBottomRightTopLeftIn::TRevealBottomRightTopLeftIn() : TTransitionEffect(true)	//	This is an In Transition
{
}


TRevealBottomRightTopLeftIn::TRevealBottomRightTopLeftIn(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TRevealBottomRightTopLeftIn::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t TRevealBottomRightTopLeftIn::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TRevealBottomRightTopLeftIn");	
...
string TRevealBottomRightTopLeftIn::Name() const
{
...
BBitmap *TRevealBottomRightTopLeftIn::TransformBitmap(uint32 time, const BBitmap *source,
