#if !defined(__TWIPEBRTLOUT_H__)
#define __TWIPEBRTLOUT_H__

//---------------------------------------------------------------------
//
//	File:	TWipeBottomRightToTopLeftOut.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class TWipeBottomRightToTopLeftOut : public TTransitionEffect 
{
	public:
		TWipeBottomRightToTopLeftOut();
		
		// Construct self from a message
		TWipeBottomRightToTopLeftOut(BMessage* msg);
