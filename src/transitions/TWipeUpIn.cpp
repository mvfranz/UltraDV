...
//	Local Constants
const char *TWipeUpIn::kTransitionName = "WipeUpIn";
...
TWipeUpIn::TWipeUpIn() : TTransitionEffect(true)	//	This is an In Transition
{
}


TWipeUpIn::TWipeUpIn(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TWipeUpIn::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t TWipeUpIn::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TWipeUpIn");	
...
BBitmap *TWipeUpIn::TransformBitmap(uint32 time, const BBitmap *source,
