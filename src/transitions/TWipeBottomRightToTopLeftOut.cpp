//---------------------------------------------------------------------
//
//	File:	TWipeBottomRightToTopLeftOut.cpp
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.14.98
...
#include "TWipeBottomRightToTopLeftOut.h"


//	Local Constants
const char *TWipeBottomRightToTopLeftOut::kTransitionName = "WipeBottomRightToTopLeftOut";
...
TWipeBottomRightToTopLeftOut::TWipeBottomRightToTopLeftOut() : TTransitionEffect(false)	//	This is an Out Transition
{
}


TWipeBottomRightToTopLeftOut::TWipeBottomRightToTopLeftOut(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TWipeBottomRightToTopLeftOut::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t TWipeBottomRightToTopLeftOut::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TWipeBottomRightToTopLeftOut");	
...
string TWipeBottomRightToTopLeftOut::Name() const
{
...
BBitmap *TWipeBottomRightToTopLeftOut::TransformBitmap(uint32 time, const BBitmap *source,
