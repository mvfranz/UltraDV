#if !defined(__TREVEALLEFTOUT_H__)
#define __TREVEALLEFTOUT_H__

//---------------------------------------------------------------------
//
//	File:	TRevealLeftOut.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class TRevealLeftOut : public TTransitionEffect 
{
	public:
		TRevealLeftOut();
		
		// Construct self from a message
		TRevealLeftOut(BMessage* msg);
