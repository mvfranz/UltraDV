#if !defined(__TREVEALRIGHTIN_H__)
#define __TREVEALRIGHTIN_H__

//---------------------------------------------------------------------
//
//	File:	TRevealRightIn.h
//
//	Author:	Gene Z. Ragan
//
//	Date:	11.11.98
...
class TRevealRightIn : public TTransitionEffect 
{
	public:
		TRevealRightIn();
		
		// Construct self from a message
		TRevealRightIn(BMessage* msg);
