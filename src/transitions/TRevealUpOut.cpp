...
#include "TRevealUpOut.h"


//	Local Constants
const char *TRevealUpOut::kTransitionName = "RevealUpOut";
...
TRevealUpOut::TRevealUpOut() : TTransitionEffect(false)	//	This is an Out Transition
{
}


TRevealUpOut::TRevealUpOut(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TRevealUpOut::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t TRevealUpOut::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TRevealUpOut");	
...
string TRevealUpOut::Name() const
{
...
BBitmap *TRevealUpOut::TransformBitmap(uint32 time, const BBitmap *source,
