...
#include "TWipeLeftOut.h"


//	Local Constants
const char *TWipeLeftOut::kTransitionName = "WipeLeftOut";
...
TWipeLeftOut::TWipeLeftOut() : TTransitionEffect(false)	//	This is an Out Transition
{
}


TWipeLeftOut::TWipeLeftOut(BMessage* msg) : TTransitionEffect(msg)
{
}
...
BArchivable* TWipeLeftOut::Instantiate(BMessage* data)
{
	return NULL; 
}

status_t TWipeLeftOut::Archive(BMessage* data, bool deep) const
{
	...
	data->AddString("class", "TWipeLeftOut");	
...
string TWipeLeftOut::Name() const
{
...
BBitmap *TWipeLeftOut::TransformBitmap(uint32 time, const BBitmap *source,
